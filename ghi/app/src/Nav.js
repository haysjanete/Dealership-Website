        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div className="nav-item dropdown p-2">
            ...
            <li className="dropdown-menu">
              ...
              <NavLink className="dropdown-item btn-outline-info" to="/automobiles">Automobiles</NavLink>
              <hr className="dropdown-divider" />
              ...
              <NavLink className="dropdown-item btn-outline-info" to="/new-automobile">New Automobile</NavLink>
            </li>
          </div>
        </div>
      </div>
